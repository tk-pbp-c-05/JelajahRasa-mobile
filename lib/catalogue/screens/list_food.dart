...
class _FoodPageState extends State<FoodPage> {
  ...
  Future<void> _reportFood(BuildContext context, CookieRequest request, String foodId) async {
    try {
  ...
  void _showReportDialog(BuildContext context, CookieRequest request, String foodId) {
    showDialog(
      context: context,
              ...
              children: [
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(value: 'incorrect_info', child: Text('Incorrect Information')),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            _showReportDialog(context, request, food.pk);
                                          },
                                        ),
                                      ],
                                    ),
